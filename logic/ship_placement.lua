...
local function has_connected_stock(wagon)
    ...
    if wagon_pos > 0 then
        if wagon.name == "cargo_ship" or wagon.name == "oil_tanker" or wagon.name == "artillery_ship" then
        ...
        elseif wagon.name == "cargo_ship_engine" then
            if wagon_pos > 1 and (train.carriages[wagon_pos - 1].name == "cargo_ship" or train.carriages[wagon_pos - 1].name == "oil_tanker" or train.carriages[wagon_pos - 1].name == "artillery_ship") then
                --game.print("found "..train.carriages[wagon_pos-1].name.." in front of "..wagon.name)
                return true
            end
...
function On_Train_Created(e)
    ...
    if global.connection_counter > 5 then
        return
    end
    ...
    if contains_ship_engine then
        ...
        elseif #parts > 2 then
            for i = 1, #parts do
                ...
                if parts[i].name == "cargo_ship" or parts[i].name == "oil_tanker" or parts[i].name == "boat_engine" or parts[i].name == "artillery_ship" then
