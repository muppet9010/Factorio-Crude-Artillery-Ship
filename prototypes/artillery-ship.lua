...
local artilleryCargoShip_entity = FactorioUtil.table.deepcopy(data.raw["cargo-wagon"]["cargo_ship"])
...
artilleryCargoShip_entity.pictures.layers[3] = FactorioUtil.table.deepcopy(refArtilleryWagon.pictures.layers[1])
...
artilleryCargoShip_entity.pictures.layers[4] = FactorioUtil.table.deepcopy(refArtilleryWagon.pictures.layers[2])
...
artilleryCargoShip_entity.cannon_barrel_pictures = FactorioUtil.table.deepcopy(refArtilleryWagon.cannon_barrel_pictures)
...
artilleryCargoShip_entity.cannon_barrel_recoil_shiftings = FactorioUtil.table.deepcopy(refArtilleryWagon.cannon_barrel_recoil_shiftings)
artilleryCargoShip_entity.cannon_barrel_recoil_shiftings_load_correction_matrix = FactorioUtil.table.deepcopy(refArtilleryWagon.cannon_barrel_recoil_shiftings_load_correction_matrix)
artilleryCargoShip_entity.cannon_base_pictures = FactorioUtil.table.deepcopy(refArtilleryWagon.cannon_base_pictures)
...
artilleryCargoShip_entity.cannon_base_shiftings = FactorioUtil.table.deepcopy(refArtilleryWagon.cannon_base_shiftings)
...
local artilleryCargoShip_gun = FactorioUtil.table.deepcopy(data.raw["gun"]["artillery-wagon-cannon"])
...
local artilleryCargoShip_item = FactorioUtil.table.deepcopy(data.raw["item-with-entity-data"]["cargo_ship"])
